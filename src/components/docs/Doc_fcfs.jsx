    ...
    <div>
      ...
      <div className="overflow-x-auto mt-3">
        <table className="min-w-full border border-gray-700 font-semibold text-center ">
          <thead className="bg-gradient-to-r from-primary-accent to-waiting text-white">
            <tr>
      ...
      <ul className="mt-3 list-disc">
        ...
        <li className="text-lg">
          <span className="font-semibold">Average Waiting Time: </span> = 4.33
        </li>
      </ul>
      ...
      <ul className="mt-3 list-disc">
        ...
        <li className="text-lg">
          <span className="font-semibold">Average Waiting Time: </span> = 1.67
        </li>
      </ul>
      ...
      <ul className="mt-3 list-disc">
        ...
        <li className="text-lg">
          ...
          This ensures that no process is arbitrarily prioritized over another.
        </li>
        <li className="text-lg">
      ...
      <ul className="mt-3 list-disc">
        ...
        <li className="text-lg">
          ...
          have to wait a long time if they arrive after longer tasks, which
          leads to poor performance in systems with a mix of long and short
          tasks.
        </li>
        <li className="text-lg">
